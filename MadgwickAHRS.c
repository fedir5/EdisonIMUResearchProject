...
//#define sampleFreq	0.02f		// sample frequency in Hz
float sampleFreq;

#define betaDef		0.08f		// 2 * proportional gain 
//#define betaDef		0.078f		// 2 * proportional gain 
//0.5 seemed nice 0.4 less nice? .75 also less nice
//betaDef used to say 0.1f, sample Freq said 524.0f??
...
// AHRS algorithm update
	...
	//processQuaternions in another class added by Fedir
...
void MadgwickAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, int timer, float timeDif) {
	...
	sampleFreq = 1.0f / timeDif;  //delete this if turns out constant sample Freq - Fedir
...
s3= _2q1*(2.0f*(q1q3 - q0q2) - ax) +   _2q2*(2.0f*(q0q1 + q2q3) - ay)+(-_8bx*q3+_4bz*q1)*(_4bx*(0.5 - q2q2 - q3q3) + _4bz*(q1q3 - q0q2) - mx)+(-_4bx*q0+_4bz*q2)*(_4bx*(q1q2 - q0q3) + _4bz*(q0q1 + q2q3) - my)+(_4bx*q1)*(_4bx*(q0q2 + q1q3) + _4bz*(0.5 - q1q1 - q2q2) - mz);
	...
	processQuaternions(q0, q1, q2, q3, timer);
	//process line added by Fedir
}
...
void MadgwickAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az) {
	...
	processQuaternions(q0, q1, q2, q3, 0);
	//process line added by Fedir
